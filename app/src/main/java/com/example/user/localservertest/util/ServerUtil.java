...
public class ServerUtil {
    ...
    private final static String BASE_URL = "http://192.168.20.79:8080/tje"; // 라이브서버
    ...
    public static void test2(final Context context,final int lectureId, final JsonResponseHandler handler) {
